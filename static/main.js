...
$(document).ready(function(){
    ...
    $($("#myChart").get(0)).attr('width',$(document).width()-40);
...
var draw = function(ctx,dataArray){
    ...
    var preAQI = allNum/hasDataNum;
    var preAQIarray = new Array();
    for(var i = 0;i<dataArrayLength;i++){
        preAQIarray.push(preAQI);
    }
    $($('#AQI').get(0)).text(Math.round(Number(preAQI)));
    var canvasData = {
        labels : dataArray,
        datasets : [
            {
